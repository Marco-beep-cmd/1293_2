...
function showQuestion() {
    ...
    quizContainer.innerHTML = `
        ...
        <img src="${currentQuestion.image}" alt="Question Image" width="70%" height="70%">
        <div>
    ...
    // Desplazarse automáticamente hacia abajo para ver las alternativas
    setTimeout(() => {
        quizContainer.scrollIntoView({ behavior: 'smooth' });
    }, 200); // Añade un pequeño retraso para que el scroll se vea suave

    // Escuchar los clics de las opciones
